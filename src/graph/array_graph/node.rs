...
mod tests {
    ...
    fn test_serialize_deserialize_node() {
        ...
        let node: NodeType = ArrayNode::new(DefaultWeight::new(42, Some(NodeIndex::new(2)), 2), EdgeIndex::new(2), 43);
    ...
    fn test_serialize_deserialize_node_with_fixint() {
        ...
        let node: T = ArrayNode::new(DefaultWeight::new(42, Some(NodeIndex::new(2)), 2), EdgeIndex::new(2), 43);
